...
would_you_rather_questions = [
    {
        "question": "db lach measba mne chno biti diri liya ?",
        "option1": "t9otlini ",
        "option2": "tbossini",
        "response1": "yk yk ahube yk ana bibik",
        "response2": "mommyyyyyyyyyyyyy ❤️"
    },
    {
        "question": "ila met ana  ?",
        "option1": " atbki o tnsayni ",
        "option2": "atbki o tbqay tje endi dema l9abri  ",
        "response1": " i think u cant babe tnsayni ",
        "response2": "knmooot elk hube  ❤️"
    },
    {
        "question": "Would you rather tfarji meaya fl barca o la ntmchaw? ",
        "option1": "barcaaaa",
        "option2": "ntmchaww",
...
with st.container():
    ...
    if st.session_state.page == 'main':
        ...
        st.markdown('<h1>Hey hube douae kolikhti !</h1>', unsafe_allow_html=True)
    ...
    # Memory Game
        ...
        if memory_message.strip():
            message = f"Sweet message from douae: {memory_message}"
